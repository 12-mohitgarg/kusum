...
// Helper component to handle scrolling to hash elements (e.g. #bilona-process)
const ScrollToHashElement: React.FC = () => {
  ...
  useEffect(() => {
    if (hash) {
      ...
      if (element) {
        // Delay slightly to ensure page load/render is complete
...
// Layout wrapper to conditionally show/hide site headers & footers
const AppContent: React.FC<{
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      {/* Scroll to URL Hash fragments */}
      <ScrollToHashElement />

      {/* Header Navigation */}
      {!isAdminPage && <Navbar onCartToggle={() => setIsCartOpen(true)} />}
